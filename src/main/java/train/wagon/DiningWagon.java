...
public class DiningWagon extends Wagon {
    private final int DEFAULT_WEIGHT_IN_TONS = 50;
    private final int DEFAULT_LENGTH_IN_METERS = 30;
    private final int MAX_PASSENGER_CAPACITY = 150;

    @Override
    public WagonTypes getWagonTypes() {
        return WagonTypes.DINING;
    }

    private final WagonTypes DINING_TYPE_WAGON = WagonTypes.SLEEPING;

    public DiningWagon(int yearOfProduction, String serialNumber, String manufacturer,
                       int wagonId) {
